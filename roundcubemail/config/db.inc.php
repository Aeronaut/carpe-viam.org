...
$rcmail_config['default_host'] = 'ssl://imap.worldserver.net';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'ssl://smtp.worldserver.net';
...
$rcmail_config['des_key'] = 'd?QRr6nzKu=hEn6E=Qlzerg%';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['username_domain'] = '@carpe-viam.org';
...
$rcmail_config['product_name'] = 'Carpe-Viam Infomailer';
...
$rcmail_config['drafts_mbox'] = 'Archiv';
...
$rcmail_config['default_imap_folders'] = array('INBOX', 'Archiv', 'Gesendet', 'Spam', 'Trash');
